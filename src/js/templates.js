...
<article class="game-preview">
  ...
  <div>
    <div class="game-preview-info">
      ...
      <a href="https://click.linksynergy.com/deeplink?id=jIIkBhIxUyI&mid=24542&murl=${encodeURIComponent(`https://www.xbox.com/es-AR/games/store/${slugify(game.title)}/${game.id}`)}" class="game-buy-now btn" rel="nofollow noopener">
